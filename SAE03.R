...
## plot(MU284$ME84, MU284$RMT85, xlab="ME84", ylab="RMT85", xlim=c(0, 10000))


###################################################
### code chunk number 3: SAE03.Rnw:201-202
###################################################
survlm<-lm(RMT85~ME84, dsmp)
survglm<-svyglm(RMT85~ME84, svy)
plot(MU284$ME84, MU284$RMT85, xlab="ME84", ylab="RMT85", xlim=c(0, 10000))
...
###################################################
### code chunk number 4: SAE03.Rnw:207-208 (eval = FALSE)
###################################################
## survlm<-lm(RMT85~ME84, dsmp)
## survglm<-svyglm(RMT85~ME84, svy)
## plot(MU284$ME84, MU284$RMT85, xlab="ME84", ylab="RMT85", xlim=c(0, 10000))
...
###################################################
### code chunk number 5: SAE03.Rnw:340-349
###################################################
library(nlme)
...
###################################################
### code chunk number 6: SAE03.Rnw:358-366
###################################################
...
###################################################
### code chunk number 7: SAE03.Rnw:407-411
###################################################
#One variance
...
###################################################
### code chunk number 8: SAE03.Rnw:419-428
###################################################
#Region-level variances
#dsmp$REG<-as.factor(dsmp$REG)
...
###################################################
### code chunk number 11: SAE03.Rnw:519-530
###################################################
...
###################################################
### code chunk number 12: SAE03.Rnw:554-555
###################################################
