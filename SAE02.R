...
###################################################
### code chunk number 1: SAE02.Rnw:263-270 (eval = FALSE)
###################################################
## library(sampling)
## data(MU284)
## 
...
###################################################
### code chunk number 2: SAE02.Rnw:273-278
###################################################
library(sampling)
data(MU284)
...
###################################################
### code chunk number 3: SAE02.Rnw:304-315
###################################################
library(maptools)
...
swreg<-SpatialPolygonsDataFrame(swreg, data.frame(REG=as.factor(1:8)), match.ID =FALSE)


###################################################
### code chunk number 4: SAE02.Rnw:318-322
###################################################
...
###################################################
### code chunk number 5: SAE02.Rnw:328-334
###################################################
#Neighbours
library(spdep)
...
###################################################
### code chunk number 6: SAE02.Rnw:352-363
###################################################
...
###################################################
### code chunk number 7: SAE02.Rnw:383-392
###################################################
...
###################################################
### code chunk number 8: SAE02.Rnw:419-428
###################################################
...
###################################################
### code chunk number 9: SAE02.Rnw:440-453
###################################################
...
###################################################
### code chunk number 10: SAE02.Rnw:482-491
###################################################
library(survey)
...
###################################################
### code chunk number 11: SAE02.Rnw:503-507
###################################################
...
###################################################
### code chunk number 12: SAE02.Rnw:514-519
###################################################
fpc<-lreg[dsmpcl$REG]
...
###################################################
### code chunk number 13: SAE02.Rnw:526-532
###################################################
...
###################################################
### code chunk number 14: SAE02.Rnw:549-553
###################################################
...
###################################################
### code chunk number 15: SAE02.Rnw:569-572
###################################################
...
###################################################
### code chunk number 16: SAE02.Rnw:591-594
###################################################
...
###################################################
### code chunk number 17: SAE02.Rnw:657-672
###################################################
...
###################################################
### code chunk number 18: SAE02.Rnw:770-783
###################################################
...
###################################################
### code chunk number 19: SAE02.Rnw:789-798
###################################################
plot(RMT85REG, destdom[,2], pch=19, xlab="True RMT85", ylab="Estimated RMT85", 
...
###################################################
### code chunk number 20: SAE02.Rnw:809-810
###################################################
