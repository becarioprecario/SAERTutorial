...
###################################################
### code chunk number 1: SAE06.Rnw:174-203
###################################################
library(maptools)
library(spdep)
library(rgdal)
...
###################################################
### code chunk number 2: SAE06.Rnw:211-234
###################################################
library(R2WinBUGS)
...
###################################################
### code chunk number 6: SAE06.Rnw:289-290 (eval = FALSE)
###################################################
## library(RColorBrewer)
## brks<-quantile(nc$SMR, seq(0,1,1/5))
## 
...
###################################################
### code chunk number 7: SAE06.Rnw:363-383 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: SAE06.Rnw:386-387
###################################################
...
###################################################
### code chunk number 10: SAE06.Rnw:411-412 (eval = FALSE)
###################################################
## library(maptools)
## Sweden<-readShapePoly(fn="Sweden_municipality")
## Sweden<-unionSpatialPolygons(Sweden,Sweden$KOD83_91)
